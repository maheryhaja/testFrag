...
class HighlightView {
    ...
    protected void draw(Canvas canvas) {
        ...
        /***
         * Modification du code par jean marc : suppression de ----> if (mMode == ModifyMode.Grow) {
         *
         * Cette modification permet d'afficher en permanence les flêches
         * voir aussi la modification dans la methode moveBy()
         */
    ...
    void moveBy(float dx, float dy) {
        ...
        /***
         * Modification du code par jean marc
         * Cette modification permet d'afficher en permanence les flêches
         *
         */
